package com.curise.eshop.email.Generator;
...
public class MyBatisPlusGenerator {
    ...
    public void codeGenerator() {
        ...
        gc.setAuthor("TZHH");//Mapper,Service类注解中显示创建人信息
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/sys?serverTimezone=UTC&useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.curise.eshop.email");  //父级公用包名，就是自动生成的文件放在项目路径下的那个包中
